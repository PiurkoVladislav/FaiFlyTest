...
public class Constants {
    ...
    public static final String TEXTURE_ATLAS = "image/withoutBrakes.pack.atlas";

    public static final String CAR_SPRITE = "car";
    public static final Vector2 CAR_EYE_POSITION = new Vector2(16,24);
    public static final float CAR_EYE_HEIGHT = 16.0f;
